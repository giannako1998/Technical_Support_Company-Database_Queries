-- Query 1: Εύρεση όλων των ανοιχτών (Open) ή σε εξέλιξη (In Progress) αιτημάτων, ταξινομημένων κατά υψηλή προτεραιότητα (High/Urgent),
-- ώστε να γνωρίζεις με τι πρέπει να ασχοληθείς άμεσα.
-
SELECT
    T.ticket_id,
    T.subject,
...
-- Query 4: Ενημέρωση κατάστασης ενός Ticket μετά την επίλυση
-- (Υποθέτουμε ότι επιλύθηκε το Ticket 4)
